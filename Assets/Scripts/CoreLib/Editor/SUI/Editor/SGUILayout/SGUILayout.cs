...
namespace Corelib.SUI
{
    public class SGUILayout : SUIElement
    {
        ...
        public static SGUILayoutButton Button(GUIContent guiContent)
            => new SGUILayoutButton(guiContent);

        public static SGUILayoutIconButton IconButton(GUIContent guiContent)
            => new SGUILayoutIconButton(guiContent);

        public static SGUILayoutIcon Icon(GUIContent guiContent)
            => new SGUILayoutIcon(guiContent);
