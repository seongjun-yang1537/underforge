...
namespace Corelib.Utils
{
        ...
        public static readonly List<Vector3Int> DIR6 = new()
    {
        ...
        public static Vector3Int RoundToMultiple(this Vector3Int v, int multiple)
        {
            return new Vector3Int(
                RoundToMultiple(v.x, multiple),
                RoundToMultiple(v.y, multiple),
                RoundToMultiple(v.z, multiple)
            );
        }

        public static Vector3Int DivideFloor(this Vector3Int value, int divisor)
        {
            return new Vector3Int(
                value.x.DivideFloor(divisor),
                value.y.DivideFloor(divisor),
                value.z.DivideFloor(divisor)
            );
        }

        public static Vector3Int ModuloFloor(this Vector3Int value, int divisor)
        {
            return new Vector3Int(
                value.x.ModuloFloor(divisor),
                value.y.ModuloFloor(divisor),
                value.z.ModuloFloor(divisor)
            );
        }
        ...
        public static int3 ToInt3(this Vector3Int vec)
            => new int3(vec.x, vec.y, vec.z);
